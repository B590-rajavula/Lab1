package iu.b590.spring2025.midtermsection4
...
import iu.b590.spring2025.midtermsection4.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startAnimation() {
        ...
        val nightSkyAnimator
                =
            ObjectAnimator
                .ofInt(binding.sky, "backgroundColor", sunsetSkyColor,
                    nightSkyColor)
                .setDuration(1500)
